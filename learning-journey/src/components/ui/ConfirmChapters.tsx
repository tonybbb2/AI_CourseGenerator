    ...
    return (
        <div className='w-full mt-4'>
            {course.units.map((unit, unitIndex) => {
                return <div key={unit.id} className='mt-5'>
            ...
            <div className='flex items-center justify-center mt-4'>
                ...
                <div className='flex items-center mx-4'>
                    <Link href='/creation' className={buttonVariants({
                        variant : "secondary",
                    })}
                    >
                    ...
                    </Link>
                    {
                        totalChaptersCount === completedChapters.size ? (
                            ...
                            })} href={`/course/${course.id}/0/0`}>Save & continue <ChevronRight className='w-4 h-4 ml-2'/></Link>
                        ) : (
                    <Button type='button' 
                        className='ml-4 font-semibold'
                        disabled={loading}
